    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_per_unit', models.CharField(default=1, max_length=20, null=True)),
                ('unit_price', models.FloatField(null=True)),
                ('units_in_stock', models.SmallIntegerField(default=0, null=True)),
                ('units_on_order', models.SmallIntegerField(default=0, null=True)),
                ('reorder_level', models.SmallIntegerField(default=0, null=True)),
                ('discontinued', models.IntegerField(default=0)),
                ('picture', models.ImageField(blank=True, null=True, upload_to='')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='northwind.category')),
                ('supplier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='northwind.supplier')),
            ],
            options={
                'db_table': 'products',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='northwind.customer')),
                ('employee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='northwind.employee')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='northwind.CustomerDemographic'),
        ),
        migrations.CreateModel(
            name='OrderDetail',
            fields=[
                ...
                ('order', models.ForeignKey(db_column='order_id', on_delete=django.db.models.deletion.CASCADE, to='northwind.order')),
                ('product', models.ForeignKey(db_column='product_id', on_delete=django.db.models.deletion.DO_NOTHING, to='northwind.product')),
            ],
            options={
